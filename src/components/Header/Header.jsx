...
export const Header = ({ordersCount}) =>{
    ...
    return(
        <>
        {!(isMobile && (pathname=='/cart' || pathname == '/account' || pathname == '/account/profile' || pathname == '/account/reviews' || pathname == '/account/orders' || pathname.includes('/account/orders' )|| pathname == '/login' || pathname == '/account/favorites')) &&
        <header>
            <div className={cls.headerContent}>
                ...
                <input className={cls.mobileSearch} placeholder='Ищите все для стройки и ремонта '/></div>}
            </div>
        </header>
        }
        {isOpen && <CatalogMenu />}
        ...
        <div className={cls.mobileControlPanel}>
            ...
            <ControlBtn nav='/cart'>
                {pathname == '/cart'? 
                    ...
                    <path d="M12 4.56205L7.76825 9.64018C7.41468 10.0645 6.78412 10.1218 6.35984 9.76822C5.93556 9.41466 5.87824 8.78409 6.2318 8.35982L11.2318 2.35982C11.6316 1.88006 12.3685 1.88006 12.7682 2.35982L17.7682 8.35982C18.1218 8.78409 18.0645 9.41466 17.6402 9.76822C17.2159 10.1218 16.5854 10.0645 16.2318 9.64018L12 4.56205Z" fill="url(#paint0_linear_675_16624)"/>
                    <path d="M19.4995 9C20.0518 9 20.4995 9.44772 20.4995 10V18C20.4995 19.6569 19.1564 21 17.4995 21H6.49854C4.84189 20.9998 3.49854 19.6567 3.49854 18V10C3.49854 9.44787 3.94646 9.00025 4.49854 9H19.4995ZM11.9995 13C10.8951 13.0001 9.99951 13.8955 9.99951 15C9.99951 16.1045 10.8951 16.9999 11.9995 17C13.1041 17 13.9995 16.1046 13.9995 15C13.9995 13.8954 13.1041 13 11.9995 13Z" fill="black"/>
                    <path d="M19.4995 9C20.0518 9 20.4995 9.44772 20.4995 10V18C20.4995 19.6569 19.1564 21 17.4995 21H6.49854C4.84189 20.9998 3.49854 19.6567 3.49854 18V10C3.49854 9.44787 3.94646 9.00025 4.49854 9H19.4995ZM11.9995 13C10.8951 13.0001 9.99951 13.8955 9.99951 15C9.99951 16.1045 10.8951 16.9999 11.9995 17C13.1041 17 13.9995 16.1046 13.9995 15C13.9995 13.8954 13.1041 13 11.9995 13Z" fill="url(#paint1_linear_675_16624)"/>
                    <defs>
                        <linearGradient id="paint0_linear_675_16624" x1="12" y1="2" x2="12" y2="10" gradientUnits="userSpaceOnUse">
                        <stop stopColor="#FF5A00"/>
                        <stop offset="1" stopColor="#EB2B00"/>
                        </linearGradient>
                        <linearGradient id="paint1_linear_675_16624" x1="11.999" y1="9" x2="11.999" y2="21" gradientUnits="userSpaceOnUse">
                        <stop stopColor="#FF5A00"/>
                        <stop offset="1" stopColor="#EB2B00"/>
                        </linearGradient>
                    </defs>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path d="M12 4.56205L7.76825 9.64018C7.41468 10.0645 6.78412 10.1218 6.35984 9.76822C5.93556 9.41466 5.87824 8.78409 6.2318 8.35982L11.2318 2.35982C11.6316 1.88006 12.3685 1.88006 12.7682 2.35982L17.7682 8.35982C18.1218 8.78409 18.0645 9.41466 17.6402 9.76822C17.2159 10.1218 16.5854 10.0645 16.2318 9.64018L12 4.56205Z" fill="#757575"/>
                    <path d="M19.4998 9C20.052 9 20.4998 9.44772 20.4998 10V18C20.4998 19.6569 19.1566 21 17.4998 21H6.49878C4.84213 20.9998 3.49878 19.6567 3.49878 18V10C3.49878 9.44787 3.9467 9.00025 4.49878 9H19.4998ZM11.9998 13C10.8953 13.0001 9.99976 13.8955 9.99976 15C9.99976 16.1045 10.8953 16.9999 11.9998 17C13.1043 17 13.9998 16.1046 13.9998 15C13.9998 13.8954 13.1043 13 11.9998 13Z" fill="#B8B8B8"/>
                    </svg>            
                }
                <p>Корзина</p>
                {cartItems.length!== 0 && <CounterBadge count={cartItems.length}/>}
            ...
            <ControlBtn  nav="/account">
                {(pathname == '/account'||pathname =='/account/orders'||pathname=='/account/reviews'||pathname=='/account/profile'            )?
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path d="M12 11C9.79086 11 8 9.20914 8 7C8 4.79086 9.79086 3 12 3C14.2091 3 16 4.79086 16 7C16 9.20914 14.2091 11 12 11Z" fill="black"/>
                    <path d="M12 11C9.79086 11 8 9.20914 8 7C8 4.79086 9.79086 3 12 3C14.2091 3 16 4.79086 16 7C16 9.20914 14.2091 11 12 11Z" fill="url(#paint0_linear_675_19161)"/>
                    <path d="M3.00065 20.1992C3.38826 15.4265 7.26191 13 11.9833 13C16.7712 13 20.7049 15.2932 20.9979 20.2C21.0096 20.3955 20.9979 21 20.2467 21C16.5411 21 11.0347 21 3.7275 21C3.47671 21 2.97954 20.4592 3.00065 20.1992Z" fill="black"/>
                    <path d="M3.00065 20.1992C3.38826 15.4265 7.26191 13 11.9833 13C16.7712 13 20.7049 15.2932 20.9979 20.2C21.0096 20.3955 20.9979 21 20.2467 21C16.5411 21 11.0347 21 3.7275 21C3.47671 21 2.97954 20.4592 3.00065 20.1992Z" fill="url(#paint1_linear_675_19161)"/>
                    <defs>
                        <linearGradient id="paint0_linear_675_19161" x1="12" y1="3" x2="12" y2="11" gradientUnits="userSpaceOnUse">
                        <stop stopColor="#FF5A00"/>
                        <stop offset="1" stopColor="#EB2B00"/>
                        </linearGradient>
                        <linearGradient id="paint1_linear_675_19161" x1="12" y1="13" x2="12" y2="21" gradientUnits="userSpaceOnUse">
                        <stop stopColor="#FF5A00"/>
                        <stop offset="1" stopColor="#EB2B00"/>
                        </linearGradient>
                    </defs>
                    ...
                    :
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path d="M12 11C9.79086 11 8 9.20914 8 7C8 4.79086 9.79086 3 12 3C14.2091 3 16 4.79086 16 7C16 9.20914 14.2091 11 12 11Z" fill="#757575"/>
                    <path d="M3.00065 20.1992C3.38826 15.4265 7.26191 13 11.9833 13C16.7712 13 20.7049 15.2932 20.9979 20.2C21.0096 20.3955 20.9979 21 20.2467 21C16.5411 21 11.0347 21 3.7275 21C3.47671 21 2.97954 20.4592 3.00065 20.1992Z" fill="#B8B8B8"/>
                    </svg>
                }
                <p>Профиль</p>
            </ControlBtn>
